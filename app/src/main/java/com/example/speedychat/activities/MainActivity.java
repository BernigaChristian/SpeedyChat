...
import com.example.speedychat.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ActivityMainBinding binding; //having enabled the viewBinding the ActivitiMainBinding will be automatically generated from the XML file
