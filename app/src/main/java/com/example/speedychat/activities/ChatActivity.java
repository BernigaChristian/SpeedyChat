...
import com.example.speedychat.adapters.ChatAdapter;
import com.example.speedychat.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) ->{
        ...
        if(value != null){
            ...
            Collections.sort(chatMessages, (obj1,obj2) -> obj1.date.compareTo(obj2.date));
            if(count == 0){
